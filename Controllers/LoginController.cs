...
namespace PMS.Controllers
{
    public class LoginController : Controller
    {
        ...
        public IActionResult RegisterUser(User user)
        {
            ...
            // Create a new Profile object and assign the same FirstName and LastName
            var newProfile = new Profile
            {
                Id = newUser.UserID,
                FirstName = user.FirstName,  // Set FirstName in Profile
                LastName = user.LastName,     // Set LastName in Profile
                Email = user.Email
            };
