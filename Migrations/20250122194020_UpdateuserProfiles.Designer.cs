...
namespace PMS.Migrations
{
    ...
    [Migration("20250122194020_UpdateuserProfiles")]
            ...
            modelBuilder.Entity("PMS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            DateCreated = new DateTime(2025, 1, 23, 3, 40, 19, 177, DateTimeKind.Local).AddTicks(5707),
                            Email = "test@example.com",
                            FirstName = "Test",
                            IsActive = true,
                            LastName = "User",
                            Password = "$2a$11$OBzXcG5O5Ztcn0JZ7zjsQeaGAENGTKM6x431gnlJ3oT2Lkd85rpya",
                            Role = "Tenant"
                        });
                });
