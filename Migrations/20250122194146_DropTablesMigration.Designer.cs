...
namespace PMS.Migrations
{
    ...
    [Migration("20250122194146_DropTablesMigration")]
    partial class DropTablesMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PMS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            DateCreated = new DateTime(2025, 1, 23, 3, 41, 45, 658, DateTimeKind.Local).AddTicks(8961),
                            Email = "test@example.com",
                            FirstName = "Test",
                            IsActive = true,
                            LastName = "User",
                            Password = "$2a$11$7Gnf.Os1aQswoCUsRUDar.xG0QLZcelz9CtetHvpSljryWBwcFory",
                            Role = "Tenant"
                        });
                });
